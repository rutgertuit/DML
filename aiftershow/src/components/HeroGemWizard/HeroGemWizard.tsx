...
export const HeroGemWizard: React.FC = () => {
  ...
  return (
    <section id="hero-gem-builder" className="max-w-4xl mx-auto bg-card-dark rounded-xl shadow-lg border border-secondary/30 p-8 my-12 overflow-hidden break-words">
